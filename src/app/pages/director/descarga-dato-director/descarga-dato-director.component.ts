...
@Component({
  selector: 'app-descarga-dato-director',
  templateUrl: './descarga-dato-director.component.html',
  styleUrls: ['./descarga-dato-director.component.css']
})
export class DescargaDatoDirectorComponent implements OnInit {
