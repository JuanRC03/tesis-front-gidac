...
@Component({
  selector: 'app-conglomerado-director',
  templateUrl: './conglomerado-director.component.html',
  styleUrls: ['./conglomerado-director.component.css']
})
export class ConglomeradoDirectorComponent implements OnInit {
