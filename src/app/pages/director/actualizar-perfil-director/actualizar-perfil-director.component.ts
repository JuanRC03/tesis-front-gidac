...
@Component({
  selector: 'app-actualizar-perfil-director',
  templateUrl: './actualizar-perfil-director.component.html',
  styleUrls: ['./actualizar-perfil-director.component.css']
})
export class ActualizarPerfilDirectorComponent implements OnInit {
