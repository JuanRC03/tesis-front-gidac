...
@Component({
  selector: 'app-dato-admin-datos',
  templateUrl: './dato-admin-datos.component.html',
  styleUrls: ['./dato-admin-datos.component.css']
})
export class DatoAdminDatosComponent implements OnInit {
