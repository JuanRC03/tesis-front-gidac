...
@Component({
  selector: 'app-descargar-dato-admin-datos',
  templateUrl: './descargar-dato-admin-datos.component.html',
  styleUrls: ['./descargar-dato-admin-datos.component.css']
})
export class DescargarDatoAdminDatosComponent implements OnInit {
